...
export default {
  ...
  'GET api/getActivityList': (req, res) => {
    setTimeout(() => {
      res.send({
        code: 200,
        data: {
  ...
  'GET api/getActivityListTotal': (req, res) => {
    setTimeout(() => {
      res.send({
        code: 200,
        data: {
  ...
  'POST api/updateActivityList': (req, res) => {
    res.send({
      code: 200,
      data: 'success',
  ...
  'POST api/deleteActivityList': (req, res) => {
    if (req.body.idDel) {
      res.send({
        code: 200,
        data: 'success',
